...
print(th.country)
# บันทัดที่2ด้านล่างคือคำสั่งแบบเต็มๆที่บันทัดที่1ด้านล่างทำ
print(th.total()) 
print(Medal.total(th))
print(th.dummy(1,2))
print(Medal.dummy(th,1,2))
th.rank = 10 #สามารถสร้างattributeหรือpropertyขึ้นมาใหม่ได้เลยโดยที่ไม่จำเป็นต้องมีอยู่ในclassแต่แรก
print(th.rank)
